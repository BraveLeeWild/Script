...
### 使用方法：
  ...
  1.点击库中的Lee.conf文件，点击raw获取真实地址，复制地址备用<br>
...
## 分流
  ...
  1.默认10个策略组，其中7个为正则筛选，分别将 香港，台湾，新加坡，美国，日本，英国，土耳其地区节点筛选出来<br>
...
## 重写
  ...
  Tiktok枷锁：默认已解锁Tiktok日区，如需改区，本地在[rewrite_local]下方添加(?<=_region=)CN(?=&) url 307 US  将US更改成你想改的区域<br>
